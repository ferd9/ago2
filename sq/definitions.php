...
// definitions
define('PMBP_VERSION',"");  // this is the version of this phpMyBackupPro release
...
if (!function_exists("mysql_connect")) {
    echo "El módulo de MySQL para PHP no parece estar instalado correctamente.<br>
    Usted puede configurar el módulo de MySQL en php.ini. Leer los servidores HTTP (por ejemplo Apache) archivos de registro para obtener más información.";
    exit;    
}
