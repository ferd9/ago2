...
";
    ...
    // define menue
    $menu=array("import.php"=>F_IMPORT,"backup.php"=>F_BACKUP,"db_info.php"=>F_DB_INFO);
  ...
  <th class=\"active\">\n";
   ...
   echo "\n</th>\n </tr>\n";
    ...
    if (1) {
        ...
        if ($phpvers<4.3) echo "<tr><td>PHP ".$tmp." ".__LINE__.".</td></tr>";
    }
...
function PMBP_save_global_conf($global_conf_path="") {
    ...
    $file="<?php\n\n// This file is automatically generated and modified  ".PMBP_VERSION."\n\n";
    if (is_array($CONF)) {
...
function PMBP_email_store($attachments,$backup_info) {
    ...
    $headers="From:  on ".$CONF['sitename']." <".$all_emails[0].">".$lb."Mime-Version: 1.0".$lb."Content-Type: multipart/mixed;".$lb."\tboundary=\"".$boundary."\"";
