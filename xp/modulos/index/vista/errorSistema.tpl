...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td style="background-image:url(imagenes/ventanaAyudaCS.png)" ><strong>{encabezado}</strong></td>
  ...
  <tr>
    ...
    <td style="background-image:url(imagenes/ventanaAyudaFondo.png); padding:15px;">{mensaje}</td>
