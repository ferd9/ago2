...
/**
 * This is the model class for table "ago.perfil".
 *
 * The followings are the available columns in table 'ago.perfil':
...
class Perfil extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idperfil, url', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'nivels' => array(self::HAS_MANY, 'Nivel', 'perfil'),
		);
	}
