...
/**
 * This is the model class for table "pguia_venta_vista".
 *
 * The followings are the available columns in table 'pguia_venta_vista':
 ...
 */
class PguiaVentaVista extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return PguiaVentaVista the static model class
	 */
