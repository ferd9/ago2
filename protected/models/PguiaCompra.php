...
/**
 * This is the model class for table "pguia_compra".
 *
 * The followings are the available columns in table 'pguia_compra':
 ...
 */
class PguiaCompra extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return PguiaCompra the static model class
	 */
