...
class SaveUsController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('SaveUs');
	...
	{
		$model=new SaveUs('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SaveUs']))
			$model->attributes=$_GET['SaveUs'];
	...
	{
		$model=SaveUs::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='save-us-form')
		{
