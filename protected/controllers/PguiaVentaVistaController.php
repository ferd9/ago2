...
class PguiaVentaVistaController extends Controller
{
	/**
	...
	{
		$model=new PguiaVentaVista;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['PguiaVentaVista']))
		{
			$model->attributes=$_POST['PguiaVentaVista'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('PguiaVentaVista');
	...
	{
		$model=new PguiaVentaVista('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PguiaVentaVista']))
			$model->attributes=$_GET['PguiaVentaVista'];
	...
	{
		$model=PguiaVentaVista::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pguia-venta-vista-form')
		{
