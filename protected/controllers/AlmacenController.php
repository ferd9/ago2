...
class AlmacenController extends Controller
{
	...
	{       $nivelll=Yii::app()->user->getId();
		...
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','Empresa'),
				'users'=>array('@'),
	...
	public function actionCreate()
	{
		...
		{
                        $model->idempresa=$_POST['Empresa']['idempresa'];
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			//$this->loadModel($id)->delete();
                        ...
                        $sqlStatement="UPDATE almacen SET estado=0 WHERE idalmacen='".$id."';";
	...
	{
                $dataProvider=new CActiveDataProvider('Almacen', array(
                        'criteria'=>array(
                                'condition'=>'estado=1',
                                'order'=>'idalmacen DESC',
                                ),
                ));
	...
	{
		$model=Almacen::model()->findByPk((int)$id);
		if($model===null)
