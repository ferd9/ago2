<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('idtipo_adquisicion')); ?>:</b>
	<?php echo CHtml::encode($data->idtipo_adquisicion); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('tipo_adquisicion')); ?>:</b>
	<?php echo CHtml::encode($data->tipo_adquisicion); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('accion_save')); ?>:</b>
	<?php echo CHtml::encode($data->accion_save); ?>
	<br />
