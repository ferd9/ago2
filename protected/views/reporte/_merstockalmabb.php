...
WHERE p.idcategoria=$tipo AND p.descripcion<>'NINGUNO' AND ap.idalmacen=$alma";
...
<font color=\"#ffffff\"><strong>Listado de Stock Valorizado del $nomalmacen</strong></font>
<br>
...
header("Content-Disposition: attachment; filename=ValStA-".date('d-m-Y').".xls");
