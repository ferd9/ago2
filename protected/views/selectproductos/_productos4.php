                        ...
                        'buttons'=>array(
                            'seleccionar' => array
                                    (
                                        ...
                                        'url'=>'Yii::app()->createUrl("selectproductos/GrabarProductosguiaremisionventa", array("id"=>$data->idproducto,"activar"=>"'.$activar.'","buscar"=>"'.$buscar.'"))',
