...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		 array(
                ...
                array(
                'header'=>'Stock',
                'value'=>'AlmacenProducto::getstockproducto($data->idproducto)'),
                        ...
                        'buttons'=>array(
                            'seleccionar' => array
                                    (
                                        ...
                                        'url'=>'Yii::app()->createUrl("selectproductos/GrabarProductos", array("id"=>$data->idproducto,"activar"=>"'.$activar.'","buscar"=>"'.$buscar.'"))',
